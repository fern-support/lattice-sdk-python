...
class OAuthTokenProvider:
    ...
    def _refresh(self) -> str:
        ...
        # property_type: root=Container(type='container', container=ContainerType(root=Optional(type='optional', optional=TypeReference(root=Primitive(type='primitive', primitive=PrimitiveType(v_1=<PrimitiveTypeV1.INTEGER: 'INTEGER'>, v_2=PrimitiveTypeV2(root=Integer(default=None, validation=None, type='integer'))))))))
